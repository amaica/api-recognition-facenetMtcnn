package br.com.sinky.dl4jfacenet;
...
public class FaceDetection {
	...
	private static class CmdParam{
		...
		String libPath="/home/aurelio/FONTES/DL4J/dl4j-facenet-master/imgLibSample/Lady Gaga.jpg";
	...
	///	new JCommander(param).parse(args);
		...
		v1.loadWeightData();
		graph = v1.getGraph();
		File libPath = new File("/home/aurelio/FONTES/DL4J/dl4j-facenet-master/imgLibSample/");
	 ...
	 FaceDetection obj = new FaceDetection();
		...
		///while(true) {
			try {
				...
				////home/aurelio/FONTES/DL4J/dl4j-facenet-master/imgLibSample/Lady Gaga.jpg
				///File file = new File(sc.nextLine());
				File file = new File("/home/aurelio/FONTES/DL4J/Arnold_Schwarzenegger.jpg");
				INDArray factor = getFaceFactor(file);
				/*if(factor == null) {
